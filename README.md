...
I verified the chunking pipeline on the chosen `city_guides` corpus with a structure-aware chunker. These five chunks were generated by `chunker.py::split_documents` and each one reads as a standalone section.
